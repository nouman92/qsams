...
<section >
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Build Drawings</h1>
      </div>
      <?php
      $files = File::all();
      foreach ($files as $file) {
          ?>
        <div style="" class="col-lg-2 col-md-3 col-xs-4 thumb text-center">
            <a target="_blank" href="<?php echo './'.$file->path; ?>"><img width="100px" src="vendor/img/icon.jpg" />  </a>
